...
data = pd.read_csv('labelresultunder.csv')
epochs = 50
batch_size = 1024
classes = 5
learning_rate = 0.01
...
train_X = scaler.fit_transform(xtrain)
...
for fold_, (trn_, val_) in enumerate(folds.split(xtrain)):
...
auc=round(roc_auc_score(train_Y,oof_preds,multi_class='ovr'),4)
